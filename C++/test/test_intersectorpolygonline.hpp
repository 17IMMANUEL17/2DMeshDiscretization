...
class MockIntersector1D1D : public IIntersector1D1D {
  ...
  TEST(TestIntersectorPolygonLine, FindPolygons3)//poligono a piacere 1
  {
    vector<Point> polygonVertices;
  ...
  TEST(TestIntersectorPolygonLine, FindPolygons4)//poligono a piacere 1 -segmento finisce in un vertice
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(8);
  ...
  //test con il poligono di Dauria ma cambiando la posizione dei capi del segmento

  TEST(TestIntersectorPolygonLine, FindPolygons7) //poligono a piacere 2 D' Auria
  {
    vector<Point> polygonVertices;
  ...
  TEST(TestIntersectorPolygonLine, FindPolygons7b) //poligono a piacere 2 D' Auria ( a forma di sigma)
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(10);
  ...
  TEST(TestIntersectorPolygonLine, CutPolygonOnEdge) //for Project 2
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(10);
  ...
  TEST(TestIntersectorPolygonLine, CutPolygonOnEdge2) //for Project 2
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(10);
  ...
  TEST(TestIntersectorPolygonLine, CutPolygonOnEdge3) //for Project 2
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(4);
  ...
  TEST(TestIntersectorPolygonLine, CutPolygonOnEdge4) //for Project 2
  {
    vector<Point> polygonVertices;
    polygonVertices.resize(8);
